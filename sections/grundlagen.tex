...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item Maxima: Konstruktive Interferenz
                \item Minima: Destruktive Interferenz
            \end{itemize}
        \end{itemize}
        \column{0.5\textwidth}
        \begin{figure}[ht]
    ...
    \begin{columns}
        ...
        \begin{figure}
            \begin{tikzpicture}
                ...
                \draw[very thick,blue] (0.5,0.5) -- (1.5,1.5);

                \draw (1,2) -- (1,1); % Initial
                \draw[->] (1,1) -- (0,1); % Transmitted
            \end{tikzpicture}
        \end{figure}
        % Beugung
        \begin{figure}
            \begin{tikzpicture}
                \draw[white] (0,0) grid (2,2);
                \draw[very thick,blue,dashed] (0.5,1) -- (1.5,1); % Gitter

                \draw (1,2) -- (1,1); % Initial
                \draw[->] (1,1) -- (0.3,0.3); % Transmitted
            \end{tikzpicture}
        \end{figure}
        % Absorption
        \begin{figure}
